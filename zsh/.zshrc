...
####  | |  | | | |  \| | |_   | | |  _     |_ \| | | '_ \  ####
####  | |__| |_| | |\  |  _|  | | |_| |   ___)  _| | (_) | ####
####   \____\___/|_| \_|_|   |___\____|  |____/|_|_|\___/  ####
####                                                       ####
###############################################################
######## "CONFIG 3:16 SAYS I JUST WHOPPED YOUR ASS" ###########
###############################################################
...
alias gcy='f() { git commit -am "$*" --no-verify }; f'
alias gcp='f() { git commit -am "$*" && git push; }; f'
alias gcpy='f() { git commit -am "$*" --no-verify && git push --no-verify }; f'
